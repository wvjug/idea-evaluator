...
### BERT Classifier 
Using BERT classifier model to predict the quality of solutions in three criteria - relevance to circular economy, market potentials, and feasibility. The scripts are all stored in directory `bert_classifier`. Please see the following scripts for implementation: 
1. Main scripts: 
